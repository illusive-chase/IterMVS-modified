        ...
        if view_weights == None:
            ...
            for src_feature, src_proj in zip(src_features, src_projs["level3"]):
                ...
                view_weights.append(F.interpolate(view_weight,
                                    scale_factor=2, mode='bilinear', align_corners=False, recompute_scale_factor=True))
            ...
            for l in range(1,4):
                ...
                if not l==2:
                    ...
                    ref_feature_l = F.interpolate(ref_feature_l,
                                    scale_factor=2**(l-2), mode='bilinear', align_corners=False, recompute_scale_factor=True)
            ...
            if not self.test:
                ...
                if iter==self.iteration-1:
                    ...
                    confidence_upsampled = F.interpolate(confidence,
                                            scale_factor=4, mode='bilinear', align_corners=False, recompute_scale_factor=True)
